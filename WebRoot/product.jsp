		...
		<div class="container">
				...
				<div class="header-grid-left animated wow slideInLeft">
					<ul>
					 <%String username = (String)session.getAttribute("username"); %>
						<li><i class="glyphicon glyphicon-envelope" aria-hidden="true"></i><a href="mailto:RobotHome@bupt.edu.cn">CRETOCE@bupt.edu.cn</a></li>
			...
			<div class="logo-nav">
				<div class="logo-nav-left">
					<h1><a href="index.html">CRETOCE<span>DREAM YOUR DREAM</span></a></h1>
				</div>
	...
	<div class="footer">
		<div class="container">
			<div class="footer-logo">
				<h2><a href="index.jsp">CRETOCE<span>Be an Explorer</span></a></h2>
			</div>
			<div class="copy-right">
				<p>Copyright &copy; 2018.Company name All rights reserved. More Templates <a>CRETOCE</a></p>
			</div>
		</div>
	</div>
<!-- //footer -->
