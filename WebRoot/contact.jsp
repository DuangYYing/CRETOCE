...
<!-- header -->	
				...
				<div class="logo-nav-left1">
					...
					<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
						<ul class="nav navbar-nav">
							...
							<li class="active"><a  class="act" href="contact.jsp">CONTACT US</a></li>
						</ul>
					</div>
					</nav>
				</div>
	...
	<div class="mail">
		<div class="container">
			<h3>Contact Us</h3>
			<p class="est">You can enter your comments if you have any idea about our products or service.</p>
			<div class="mail-grids">
				<div class="col-md-7 mail-grid-left">
					<form method="post" action="./ContactServlet">
						...
						<textarea type="text" name="message" value="message"  onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'message';}" required="">Message...</textarea>
						<div class="ccccc">
							<input type="submit" name="submit" value="Submit Now" >
						</div>
					</form>
				</div>
				<div class="col-md-4 mail-grid-right">
					<div class="mail-grid-right1">
						<img src="images/5.png" alt=" " class="img-responsive" />
						<h4>GAVIN THOMAS <span>Manager</span></h4>
						<ul class="phone-mail">
							<li><i class="glyphicon glyphicon-earphone" aria-hidden="true"></i>Phone: +1234 567 893</li>
							<li><i class="glyphicon glyphicon-envelope" aria-hidden="true"></i>Email: <a href="mailto:GavinThomas@bupt.edu.cn">GavinThomas@bupt.edu.cn</a></li>
						</ul>	
					</div>
				</div>
				<div class="clearfix"> </div>
